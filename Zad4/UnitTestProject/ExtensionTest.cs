    ...
    public class ExtensionTest
    {
        ...
        public void GetProductsWithoutCategory()
        {
            using (DataClassesDataContext context = new DataClassesDataContext())
            {
                ...
                Assert.AreEqual(209, products.GetProductsWithoutCategory().Count);
                Assert.IsNull(products.GetProductsWithoutCategory().ElementAt(0).ProductSubcategory);
            }
        }
        ...
        public void GetProductVendorString()
        {
            using (DataClassesDataContext context = new DataClassesDataContext())
            {
                ...
                string[] pv1 = products.AsString(vendors).Split('\n');
                string[] pv2 = products.AsString(vendors).Split('\n');
